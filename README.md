...
在fork仓库的基础上根据自我使用需求，改变一些功能，将弹窗改为可自动消失的提示，减少一次点击 :stuck_out_tongue_closed_eyes: ：
<img width="865" height="176" alt="image" src="https://github.com/user-attachments/assets/14395704-5a10-4f2b-854c-2760240326fc" />
...
2. 点击页面左上角的菜单按钮（三条横线）。
3. 选择“设置”。
4. 在“文献管理软件”部分，勾选“显示导入BibTeX链接”选项。<img width="787" height="181" alt="image" src="https://github.com/user-attachments/assets/9edef764-4f26-4cd4-9fee-b4d659476d36" />
...
- 修改插件权限，Microsoft Edge可修改这里，没有的话可直接打开开发者模式
  <img width="1591" height="746" alt="image" src="https://github.com/user-attachments/assets/a6be8dc6-5329-4709-ac93-a71943304c9e" />
- 确保Google学术设置中已启用“导入BibTeX”选项。
- 根据使用的Google学术网站，可以修改下面地址：
```
